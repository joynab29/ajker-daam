          ...
          <div style={{ width: '100%', height: 280 }}>
            <ResponsiveContainer>
              <LineChart data={history}>
                ...
                <Tooltip />
                <Legend />
                <Line type="monotone" dataKey="avg" stroke="#166534" name="avg" />
                <Line type="monotone" dataKey="min" stroke="#15803d" name="min" />
                <Line type="monotone" dataKey="max" stroke="#4ade80" name="max" />
              </LineChart>
            </ResponsiveContainer>
          </div>
